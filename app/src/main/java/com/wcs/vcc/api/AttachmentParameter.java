...
public class AttachmentParameter {
    ...
    public AttachmentParameter(String attachmentDate, String attachmentDescription, String attachmentFile, int attachmentFileSize, UUID attachmentID, String attachmentUser, int confidentialLevel, int flag, String orderNumber, String originalFileName) {
