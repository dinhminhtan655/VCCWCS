...
public class UpdateContainerCheckingParameter {
    ...
    public UpdateContainerCheckingParameter(UUID checkingID, String dockNumber, boolean error, boolean lock, boolean noOperation, boolean productEmpty, String remark, boolean running, boolean seal, boolean stop, String temperatureSetup, String temperatureShow, boolean thawing, boolean Electricity, String userName) {
