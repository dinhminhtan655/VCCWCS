...
public class ABAGroup3FActivity extends EmdkActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_b_a_group3_f);
        ...
        lvNhom.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent i1 = new Intent(ABAGroup3FActivity.this, ABAOutbound3FActivity.class);
