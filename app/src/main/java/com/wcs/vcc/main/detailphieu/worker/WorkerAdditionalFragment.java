...
public class WorkerAdditionalFragment extends Fragment implements View.OnFocusChangeListener, View.OnClickListener {
    ...
    @BindView(R.id.et_worker_boc_xep_percent_3)
    EditText vPercentBocXep3;
    @BindView(R.id.et_worker_boc_xep_percent_4)
    EditText vPercentBocXep4;
    @BindView(R.id.et_worker_boc_xep_percent_5)
    EditText vPercentBocXep5;
    @BindView(R.id.actv_worker_boc_xep_3)
    AppCompatAutoCompleteTextView vBocXepID3;
    @BindView(R.id.actv_worker_boc_xep_4)
    AppCompatAutoCompleteTextView vBocXepID4;
    @BindView(R.id.actv_worker_boc_xep_5)
    AppCompatAutoCompleteTextView vBocXepID5;
    @BindView(R.id.actv_worker_walkie_3)
    AppCompatAutoCompleteTextView vWalkieID3;
    @BindView(R.id.actv_worker_walkie_4)
    AppCompatAutoCompleteTextView vWalkieID4;
    @BindView(R.id.et_worker_walkie_percent_3)
    EditText vPercentWalkie3;
    @BindView(R.id.et_worker_walkie_percent_4)
    EditText vPercentWalkie4;
    @BindView(R.id.actv_worker_tai_xe_2)
    AppCompatAutoCompleteTextView actvTaiXeID2;
    @BindView(R.id.et_worker_tai_xe_percent_2)
    ...
    public void setWorkerInfo(WorkerInfo info) {
        vBocXepID3.setText(String.format(Locale.US, "%d", info.GHCode3));
        vBocXepID4.setText(String.format(Locale.US, "%d", info.GHCode4));
        vBocXepID5.setText(String.format(Locale.US, "%d", info.GHCode5));
        ...
        vWalkieID3.setText(String.format(Locale.US, "%d", info.WalkieCode3));
        vWalkieID4.setText(String.format(Locale.US, "%d", info.WalkieCode4));
        ...
        actvTaiXeID2.setText(String.format(Locale.US, "%d", info.ForkliftCode2));
