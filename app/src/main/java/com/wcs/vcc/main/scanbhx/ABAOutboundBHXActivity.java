...
import com.wcs.vcc.main.scanvinmartv.ABAOutboundVinmartAdapter;
...
public class ABAOutboundBHXActivity extends RingScanActivity implements ABAListItemBHXFragment.ABAOnInputListener2 {

    private static final String TAG = "ABAOutboundBHXActivity";
    ...
    List<XDockVinOutboundPackingViewABA> list;
...
//--------------------------------------Test-----------------------------
    ...
    ItemScanAdapter adapter2;

    private ItemScanViewModel itemScanViewModel;

    private List<ItemScan> itemScanList;
...
//===================================Test-----------------------------------
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_b_a_outbound_b_h_x);
        ...
        Log.e("name", LoginPref.getRealName(ABAOutboundBHXActivity.this));
        itemScanList = new ArrayList<>();
        ...
        mediaPlayer = MediaPlayer.create(ABAOutboundBHXActivity.this, R.raw.sairoi2);
        mediaPlayer2 = MediaPlayer.create(ABAOutboundBHXActivity.this, R.raw.nhammaroi);
        list = new ArrayList<XDockVinOutboundPackingViewABA>();

        userName = LoginPref.getUsername(ABAOutboundBHXActivity.this);
        strDevice = Utilities.getAndroidID(ABAOutboundBHXActivity.this);
...
//        btChooseDate.setText(Utilities.formatDate_ddMMyyyy(reportDate));
        ...
        adapter2 = new ItemScanAdapter();
        rv_vinmartdetail.setAdapter(adapter2);
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                switch (compoundButton.getId()){
                    case R.id.toggleToiLui:
                        ...
                        Toast.makeText(ABAOutboundBHXActivity.this, "" + iToggle, Toast.LENGTH_SHORT).show();
        ...
        imgList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ABAListItemBHXFragment listItemFragment = ABAListItemBHXFragment.ABAnewInstance(reportDate2, nhom);
                listItemFragment.show(fm,null);
            }
        });


        imgSeal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent iSeal = new Intent(ABAOutboundBHXActivity.this, ABASealBHXActivity.class);
                iSeal.putExtra("date", reportDate2);
                iSeal.putExtra("nhom", nhom);
                startActivity(iSeal);
            }
        });
        ...
        btnXong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ABAOutboundBHXActivity.this);
...
//            jsonObject.addProperty("Barcode", tv_prev_barcode.getText().toString());
        ...
        jsonObject.addProperty("CustomerID", "BHX");
...
//        }
        ...
        MyRetrofit.initRequest(ABAOutboundBHXActivity.this).loadXDockBHXOutboundPackingView(jsonObject).enqueue(new Callback<List<XDockVinOutboundPackingViewABA>>() {
            @Override
...
//                        SettingPref.setCodeItem(OutboundVinmartActivity.this, tv_prev_barcode.getText().toString());
                                    ...
                                    builder.setNegativeButton("Hủy", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if (sLMove2 + Integer.parseInt(item.SLScan) > item.SoBich) {
                                                Toast.makeText(ABAOutboundBHXActivity.this, "Số move không được lớn hơn SL Chia", Toast.LENGTH_SHORT).show();
                                            } else {
                                                ...
                                                MyRetrofit.initRequest(ABAOutboundBHXActivity.this).updateXDockBHXOutboundPackingDetailMove(jsonObject2).enqueue(new Callback<String>() {
                                                    @Override
                                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                                        if (response.isSuccess() && response.body() != null) {
                                                            if (response.body().equals("OK")) {
                                                                Toast.makeText(ABAOutboundBHXActivity.this, "Thành công", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onFailure(Throwable t) {
                                                        Toast.makeText(ABAOutboundBHXActivity.this, "Kiểm tra kết nối mạng", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            }
                                        }
            ...
            @Override
            public void onFailure(Throwable t) {
                Toast.makeText(ABAOutboundBHXActivity.this, "Vui lòng kiểm tra kết nối mạng!", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                            adapter.filter(strP[1]);
                    ...
                    try {
                        if (Integer.parseInt(strP[1]) != Integer.parseInt(tvPalletCurrent.getText().toString())) {
                            ...
                            if (list.get(pos).XacNhan.equals("0")) {
                                ...
                                MyRetrofit.initRequest(ABAOutboundBHXActivity.this).updateXDockBHXOutboundPackingDetailMove(jsonObject1).enqueue(new Callback<String>() {
                                    @Override
                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                        if (response.isSuccess() && response.body() != null) {
                                            if (response.body().equals("OK")) {
                                                ...
                                                Toast.makeText(ABAOutboundBHXActivity.this, "Thất bại", Toast.LENGTH_SHORT).show();
                                            }
                ...
                if (list.size() == 0) {
                    Utilities.speakingSomeThingslow(itemName,ABAOutboundBHXActivity.this);
                    loadPackingView(tv_prev_barcode.getText().toString());
                } else if (list.size() > 0) {
