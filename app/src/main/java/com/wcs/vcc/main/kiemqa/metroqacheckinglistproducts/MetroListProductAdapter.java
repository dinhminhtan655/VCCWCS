...
public class MetroListProductAdapter extends ArrayAdapter<QACheckingListProductsInfo> implements Filterable {
    ...
    static class ViewHolder {
        @BindView(R.id.item_tv_metro_list_product_name)
        TextView tvName;
        @BindView(R.id.item_tv_metro_list_product_actual_quantity)
        TextView tvActual;
        @BindView(R.id.item_tv_metro_list_product_order_quantity)
        TextView tvOrder;
