...
public class OutboundVinmartActivity extends RingScanActivity implements ListItemFragment.OnInputListener{
    public static final String TAG = "OutboundVinmartActivity";
...
//    ImageButton btnDown;
//    @BindView(R.id.tvHisPlt)
//    TextView tvHisPlt;
//    @BindView(R.id.tvHisSLChia)
//    TextView tvHisSLChia;
//    @BindView(R.id.tvHisSLMove)
//    TextView tvHisSLMove;
//    @BindView(R.id.tvHisDC)
//    TextView tvHisDC;
//    @BindView(R.id.tvHisConfirm)
//    TextView tvHisConfirm;
//    @BindView(R.id.tvHisUpDown)
//    TextView tvHisUpDown;
    private Calendar calendar;
    private String reportDate, reportDate2, userName, strDocEntry, strDevice, strSLScan, strCode, strItemCode;
    ...
    OutboundVinmartAdapter adapter;

    int ii = 0, pos = 0;

    String currentItemCode = "";

    List<XDockVinOutboundPackingView> list;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outbound_vinmart);
        ...
        Log.e("name", LoginPref.getRealName(OutboundVinmartActivity.this));
        ...
        mediaPlayer = MediaPlayer.create(OutboundVinmartActivity.this, R.raw.sairoi2);
        mediaPlayer2 = MediaPlayer.create(OutboundVinmartActivity.this, R.raw.nhammaroi);
        list = new ArrayList<XDockVinOutboundPackingView>();

        userName = LoginPref.getUsername(OutboundVinmartActivity.this);
        strDevice = Utilities.getAndroidID(OutboundVinmartActivity.this);
...
//        btChooseDate.setText(Utilities.formatDate_ddMMyyyy(reportDate));
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                switch (compoundButton.getId()){
                    case R.id.toggleToiLui:
                        if (b){
                            iToggle = 1;
                            Toast.makeText(OutboundVinmartActivity.this, "" + iToggle, Toast.LENGTH_SHORT).show();
        ...
        imgList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ListItemFragment listItemFragment = ListItemFragment.newInstance(reportDate2, nhom);
        ...
        btnXong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(OutboundVinmartActivity.this);
...
//                        SettingPref.removeCodeItem(OutboundVinmartActivity.this);
    ...
    private void loadPackingView(final String strPreCode) {
        ...
        if (strPreCode.length() >= 13) {
            jsonObject.addProperty("ItemCode", "1");
        ...
        MyRetrofit.initRequest(OutboundVinmartActivity.this).loadXDockVinOutboundPackingView(jsonObject).enqueue(new Callback<List<XDockVinOutboundPackingView>>() {
            @Override
            public void onResponse(final Response<List<XDockVinOutboundPackingView>> response, Retrofit retrofit) {
...
//                        SettingPref.setCodeItem(OutboundVinmartActivity.this, tv_prev_barcode.getText().toString());
                    ...
                    adapter = new OutboundVinmartAdapter(new RecyclerViewItemOrderListener<XDockVinOutboundPackingView>() {
                        @Override
                        public void onClick(final XDockVinOutboundPackingView item, int position, int order) {
                            switch (order) {
                                case 0:
                                    ...
                                    builder.setNegativeButton("Hủy", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if (sLMove2 + Integer.parseInt(item.SLScan) > item.SoBich) {
                                                Toast.makeText(OutboundVinmartActivity.this, "Số move không được lớn hơn SL Chia", Toast.LENGTH_SHORT).show();
                                            } else {
                                                ...
                                                MyRetrofit.initRequest(OutboundVinmartActivity.this).updateXDockVinOutboundPackingDetailMove(jsonObject2).enqueue(new Callback<String>() {
                                                    @Override
                                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                                        if (response.isSuccess() && response.body() != null) {
                                                            if (response.body().equals("OK")) {
                                                                Toast.makeText(OutboundVinmartActivity.this, "Thành công", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onFailure(Throwable t) {
                                                        Toast.makeText(OutboundVinmartActivity.this, "Kiểm tra kết nối mạng", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            }
                                        }
                        ...
                        @Override
                        public void onLongClick(XDockVinOutboundPackingView item, int position, int order) {
                    ...
                    for (XDockVinOutboundPackingView s : list) {
            ...
            @Override
            public void onFailure(Throwable t) {
                Toast.makeText(OutboundVinmartActivity.this, "Vui lòng kiểm tra kết nối mạng!", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                            adapter.filter(strP[1]);
                    ...
                    try {
                        if (Integer.parseInt(strP[1]) != Integer.parseInt(tvPalletCurrent.getText().toString())) {
                            ...
                            if (list.get(pos).XacNhan.equals("0")) {
                                ...
                                MyRetrofit.initRequest(OutboundVinmartActivity.this).updateXDockVinOutboundPackingDetailMove(jsonObject1).enqueue(new Callback<String>() {
                                    @Override
                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                        if (response.isSuccess() && response.body() != null) {
                                            if (response.body().equals("OK")) {
                                                ...
                                                Toast.makeText(OutboundVinmartActivity.this, "Thất bại", Toast.LENGTH_SHORT).show();
                                            }
                ...
                if (list.size() == 0) {
                    Utilities.speakingSomeThingslow(itemName,OutboundVinmartActivity.this);
                    loadPackingView(tv_prev_barcode.getText().toString());
                } else if (list.size() > 0) {
...
//        soundPool = null;
    ...
    @Override
    public void sendInput(String input, String itemName) {
        strItemCode = input;
...
//        if (list.size() > 0) {
//            rv_vinmartdetail.scrollToPosition(list.size() - 1);
//        }
//    }
}
