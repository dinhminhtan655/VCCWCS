...
import com.wcs.vcc.api.InsertAssignWorkParameter;
...
public class AssignWorkAdapter extends ArrayAdapter<AssignWorkInfo> implements View.OnClickListener, Filterable {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (!userName.equalsIgnoreCase(createBy) && !Group.isEqualGroup(positionGroup, Group.MANAGER) && !Group.isEqualGroup(positionGroup, Group.SUPERVISOR)) {
    ...
    static class ViewHolder {
        ...
        @BindView(R.id.tv_qhse_assign_to)
        TextView tvAssignTo;
        @BindView(R.id.item_cb_confirm)
        CheckBox cbConfirm;
        @BindView(R.id.ratingBar)
        AppCompatRatingBar ratingBar;
        @BindView(R.id.cb_qhse_reject)
        CheckBox reject;
        @BindView(R.id.tv_qhse_order_number)
