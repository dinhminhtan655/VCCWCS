package com.wcs.vcc.main.detailphieu.so_do_day;
 ...
 */
public class LoadingReportInfo {
    ...
    @SerializedName("LoadingReportDetailID")
    private int LoadingReportDetailID;
    @SerializedName("D1")
    private int D1;
    @SerializedName("D2")
    private int D2;
    ...
    public int getLoadingReportDetailID() {
        return LoadingReportDetailID;
    }
