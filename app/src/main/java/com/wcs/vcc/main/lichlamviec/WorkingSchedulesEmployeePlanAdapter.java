...
public class WorkingSchedulesEmployeePlanAdapter extends BaseExpandableListAdapter {
    ...
    static class PlanViewHolder {
        @BindView(R.id.itemEmployeePlanID)
        TextView tvID;
        @BindView(R.id.itemEmployeePlanName)
        TextView tvName;
        @BindView(R.id.itemEmployeePlanTimeIn)
        TextView tvTimeIn;
        @BindView(R.id.itemEmployeePlanDateStatus)
        TextView tvDateStatus;
        @BindView(R.id.itemEmployeePlanNight)
        TextView tvNight;
