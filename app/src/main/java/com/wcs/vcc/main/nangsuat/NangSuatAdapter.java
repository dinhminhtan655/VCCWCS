...
public class NangSuatAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        holder.tvTotal.setText(Utilities.formatNumber(childInfo.getTOTAL()));
    ...
    static class GroupViewHolder {
        @BindView(R.id.item_tv_performance_payrollDate)
        TextView tvPayrollDate;
        @BindView(R.id.item_tv_performance_timeWork)
        TextView tvTimeWork;
        @BindView(R.id.item_tv_performance_status)
        TextView tvStatus;
        @BindView(R.id.item_tv_performance_night)
        TextView tvNight;
    ...
    static class ChildViewHolder {
        @BindView(R.id.item_tv_performance_order_number)
        TextView tvOrderNumber;
        @BindView(R.id.item_tv_performance_start_time)
        TextView tvStartTime;
        @BindView(R.id.item_tv_performance_end_time)
        TextView tvEndTime;
        @BindView(R.id.item_tv_performance_total)
        TextView tvTotal;
