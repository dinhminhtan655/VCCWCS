...
public class ABAGroupVinmartActivity extends EmdkActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_b_a_group_vinmart);
        ...
        lvNhom.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent i1 = new Intent(ABAGroupVinmartActivity.this, ABAOutboundVinmartActivity.class);
