...
public class GroupVinmartActivity extends EmdkActivity {
...
//    TextView tv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_group_vinmart);
//        ButterKnife.bind(this);
        ...
        lvNhom.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Intent i1 = new Intent(GroupVinmartActivity.this, OutboundVinmartActivity.class);
