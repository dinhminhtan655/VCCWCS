...
public class ReceivingCartonReturnAdapter extends ArrayAdapter<DSReceivingCartonReturnListInfo> implements Filterable {
    ...
    static class ViewHolder {
        @BindView(R.id.item_tv_carton_return_category)
        TextView tvCategory;
        @BindView(R.id.item_tv_carton_return_des)
        TextView tvDes;
        @BindView(R.id.item_tv_carton_return_id)
        TextView tvID;
        @BindView(R.id.item_tv_carton_return_ref)
        TextView tvRef;
        @BindView(R.id.item_tv_carton_return_size)
        TextView tvSize;
        @BindView(R.id.item_cb_carton_return)
        CheckBox cb;
