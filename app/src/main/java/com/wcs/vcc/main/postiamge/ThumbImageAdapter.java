...
public class ThumbImageAdapter extends ArrayAdapter<Thumb> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.thumbIV.setImageBitmap(ResizeImage.getOrientation(item.getBitmap(),item.getPath()));
    ...
    private class ThumbViewHolder {
        ...
        public ThumbViewHolder(View view) {
            ...
            thumbIV.setLayoutParams(new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, widthContainer));
        }
    }
}
