...
import com.wcs.vcc.api.EmployeeInOutParameter;
...
public class LichSuRaVaoActivity extends BaseActivity implements AdapterView.OnItemClickListener {
    ...
    private void getEmployeeInOut(final View view, int departmentIndex) {
        ...
        EmployeeInOutParameter parameter = new EmployeeInOutParameter(departmentIndex, reportDate, userName, storeId);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        EmployeeInOutInfo item = adapter.getItem(position);
        if (item != null) {
            Intent intent = new Intent(this, NangSuatActivity.class);
            intent.putExtra("EMPLOYEE_ID", item.getEmployeeID().toString());
