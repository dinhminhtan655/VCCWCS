...
public class PalletFindAdapter extends ArrayAdapter<PalletFind> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.customerRefTV.setText(String.format("Ref1:  %s \nRef2: %s", info.getCustomerRef(), info.getCustomerRef2()));
...
//        holder.currentQtyTV.setText(String.format(Locale.getDefault(), "Tồn:  %d", info.getCurrentQuantity()));
        holder.findOriginal.setText(info.getStringQuantity());
//        holder.afterQtyTV.setText(String.format(Locale.getDefault(), "Tồn sau khi soạn:  %d", info.getAfterDPQuantity()));
...
//            holder.currentQtyTV.setVisibility(View.GONE);
    ...
    static class ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            findOriginal = (TextView) view.findViewById(R.id.item_pallet_find_original);
