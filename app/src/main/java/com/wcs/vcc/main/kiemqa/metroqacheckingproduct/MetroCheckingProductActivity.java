package com.wcs.vcc.main.kiemqa.metroqacheckingproduct;
...
import com.wcs.vcc.main.kiemqa.metroqacheckingcarton.MetroCartonActivity;
...
import com.wcs.vcc.api.MetroQACheckingProductsParameter;
...
public class MetroCheckingProductActivity extends BaseActivity {
    ...
    @BindView(R.id.tv_metro_product_kl_hong)
    TextView tvKlHong;
    @BindView(R.id.tv_metro_product_kl_kiem)
    TextView tvKlKiem;
    @BindView(R.id.tv_metro_product_name)
    TextView tvName;
    @BindView(R.id.tv_metro_product_nguoi_kiem)
    TextView tvNguoiKiem;
    @BindView(R.id.tv_metro_product_sl_dat)
    TextView tvSlDat;
    @BindView(R.id.tv_metro_product_sl_giao)
    TextView tvSlGiao;
    @BindView(R.id.tv_metro_product_sl_kiem)
    TextView tvSlKiem;
    @BindView(R.id.tv_metro_product_sl_tu_choi)
    EditText tvSlTuChoi;
    @BindView(R.id.tv_metro_product_sl_thung_giao)
    TextView tvSlThungGiao;
    @BindView(R.id.tv_metro_product_tru)
    TextView tvTru;
    @BindView(R.id.et_metro_product_ghi_chu)
    EditText etGhiChu;
    @BindView(R.id.acs_metro_product_ly_do)
        ...
        androidx.appcompat.app.AlertDialog dialog = new androidx.appcompat.app.AlertDialog.Builder(this)
                ...
                .setPositiveButton("Upload", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        progressDialog.show();
                        PostImage postImage = new PostImage(MetroCheckingProductActivity.this, progressDialog, snackBarView, etGhiChu.getText().toString(), QHSERNumber, new UploadImageCallback() {
                            @Override
