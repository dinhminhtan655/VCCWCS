...
import com.wcs.vcc.api.DSInventoryCheckingParameter;
...
public class KiemHoSoNoEMDKActivity extends EmdkActivity implements AdapterView.OnItemLongClickListener {
    ...
    ImageView ivCamera;
    @BindView(R.id.tv_kiem_ho_so_Quantity)
    TextView tvQuantity;
    @BindView(R.id.tv_kiem_ho_so_qty_scanned)
