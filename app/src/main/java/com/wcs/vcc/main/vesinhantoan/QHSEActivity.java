...
import com.wcs.vcc.api.QHSEParameter;
...
public class QHSEActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void getQHSE(final View view) {
        ...
        MyRetrofit.initRequest(this).getQHSE(new QHSEParameter(0, LoginPref.getStoreId(this))).enqueue(new Callback<List<QHSEInfo>>() {
            @Override
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.tv_qhse_new_qhse){
            startActivity(new Intent(QHSEActivity.this, NewQHSEActivity.class));
    ...
    private void showSettingsDialog() {
        AlertDialog.Builder builder = new AlertDialog.Builder(QHSEActivity.this);
