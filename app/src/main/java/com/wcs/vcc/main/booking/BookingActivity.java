package com.wcs.vcc.main.booking;
...
import com.wcs.vcc.api.CustomerBookingByTimeSlotParameter;
...
public class BookingActivity extends BaseActivity {
    ...
    public void getBooking() {
        ...
        MyRetrofit.initRequest(this).getBookings(new CustomerBookingByTimeSlotParameter(bookingDate.split("T")[0], warehouseId, storeId)).enqueue(new Callback<List<Booking>>() {
            @Override
