...
public class ABAOutbound3FActivity extends RingScanActivity implements ABAListItem3FFragment.ABAOnInputListener2 {

    private static final String TAG = "ABAOutbound3FActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_b_a_outbound3_f);
        ...
        Log.e("name", LoginPref.getRealName(ABAOutbound3FActivity.this));
        ...
        mediaPlayer = MediaPlayer.create(ABAOutbound3FActivity.this, R.raw.sairoi2);
        mediaPlayer2 = MediaPlayer.create(ABAOutbound3FActivity.this, R.raw.nhammaroi);
        list = new ArrayList<XDockVinOutboundPackingViewNewZealandABA>();

        userName = LoginPref.getUsername(ABAOutbound3FActivity.this);
        strDevice = Utilities.getAndroidID(ABAOutbound3FActivity.this);
...
//        btChooseDate.setText(Utilities.formatDate_ddMMyyyy(reportDate));
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                switch (compoundButton.getId()){
                    case R.id.toggleToiLui:
                        ...
                        Toast.makeText(ABAOutbound3FActivity.this, "" + iToggle, Toast.LENGTH_SHORT).show();
        ...
        imgList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ABAListItem3FFragment listItemFragment = ABAListItem3FFragment.ABAnewInstance(reportDate2, nhom, region);
        ...
        btnXong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ABAOutbound3FActivity.this);
...
//            jsonObject.addProperty("Barcode", tv_prev_barcode.getText().toString());
        ...
        jsonObject.addProperty("CustomerID", "1000331");
...
//        }
        ...
        MyRetrofit2.initRequest2().loadXDock3FOutboundPackingView(jsonObject).enqueue(new retrofit2.Callback<List<XDockVinOutboundPackingViewNewZealandABA>>() {
            @Override
...
//                        SettingPref.setCodeItem(OutboundVinmartActivity.this, tv_prev_barcode.getText().toString());
                                    ...
                                    builder.setNegativeButton("Hủy", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if (sLMove2 + Integer.parseInt(item.SLScan) > item.SoBich) {
                                                Toast.makeText(ABAOutbound3FActivity.this, "Số move không được lớn hơn SL Chia", Toast.LENGTH_SHORT).show();
                                            } else {
                                                ...
                                                MyRetrofit2.initRequest2().updateXDock3FOutboundPackingDetailMove(jsonObject2).enqueue(new retrofit2.Callback<String>() {
                                                    @Override
                                                    public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                                                        if (response.isSuccessful() && response.body() != null) {
                                                            if (response.body().equals("OK")) {
                                                                Toast.makeText(ABAOutbound3FActivity.this, "Thành công", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onFailure(Call<String> call, Throwable t) {
                                                        Toast.makeText(ABAOutbound3FActivity.this, "Kiểm tra kết nối mạng", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            }
                                        }
            ...
            public void onFailure(Call<List<XDockVinOutboundPackingViewNewZealandABA>> call, Throwable t) {
                Toast.makeText(ABAOutbound3FActivity.this, "Vui lòng kiểm tra kết nối mạng!", Toast.LENGTH_SHORT).show();
            }
        });
...
//                            adapter.filter(strP[1]);
                    ...
                    try {
                        if (Integer.parseInt(strP[1]) != Integer.parseInt(tvPalletCurrent.getText().toString())) {
                            ...
                            if (list.get(pos).XacNhan.equals("0")) {
                                ...
                                MyRetrofit2.initRequest2().updateXDock3FOutboundPackingDetailMove(jsonObject1).enqueue(new retrofit2.Callback<String>() {
                                    @Override
                                    public void onResponse(Call<String> call, retrofit2.Response<String> response) {
                                        if (response.isSuccessful() && response.body() != null) {
                                            if (response.body().equals('"' + "OK" + '"')) {
                                                ...
                                                Toast.makeText(ABAOutbound3FActivity.this, "Thất bại", Toast.LENGTH_SHORT).show();
                                            }
                ...
                if (list.size() == 0) {
                    Utilities.speakingSomeThingslow(itemName,ABAOutbound3FActivity.this);
                    loadPackingView(tv_prev_barcode.getText().toString());
                } else if (list.size() > 0) {
