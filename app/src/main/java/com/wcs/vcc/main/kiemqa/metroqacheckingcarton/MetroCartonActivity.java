...
import com.wcs.vcc.api.MetroQACheckingCartonInsertParameter;
import com.wcs.vcc.api.MetroQACheckingCartonParameter;
...
public class MetroCartonActivity extends BaseActivity implements AdapterView.OnItemLongClickListener {
    private final String TAG = MetroCartonActivity.class.getSimpleName();
    @BindView(R.id.lvOrderDetail)
    ListView listView;
    @BindView(R.id.tv_metro_carton_product_name)
