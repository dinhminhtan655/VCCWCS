package com.wcs.vcc.main.equipment;
...
import com.wcs.vcc.api.EquipmentInventoryParameter;
...
public class EquipmentInventoryNoEMDKActivity extends EmdkActivity {
    ...
    ImageView ivCamera;
    @BindView(R.id.tv_equipment_Quantity)
    TextView tvQuantity;
    @BindView(R.id.tv_equipment_qty_scanned)
