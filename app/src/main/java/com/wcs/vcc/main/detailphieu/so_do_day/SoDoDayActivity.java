...
import com.wcs.vcc.api.LoadingReportInsertParameter;
import com.wcs.vcc.api.LoadingReportParameter;
import com.wcs.vcc.api.LoadingReportUpdateParameter;
...
public class SoDoDayActivity extends BaseActivity implements SoDoDayAdapter.OnEditorActionListener {
    ...
    @BindView(R.id.tvTotalCartonCurrent)
