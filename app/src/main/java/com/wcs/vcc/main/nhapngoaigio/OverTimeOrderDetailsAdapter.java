...
public class OverTimeOrderDetailsAdapter extends ArrayAdapter<OverTimeOrderDetailsInfo> {
    ...
    static class ViewHolder {
        @BindView(R.id.item_tv_over_time_detail_total_weight)
        TextView tvTotalWeight;
        @BindView(R.id.item_tv_over_time_detail_start_time)
        TextView tvStartTime;
        @BindView(R.id.item_tv_over_time_detail_order_number)
        TextView tvOrderNumber;
        @BindView(R.id.item_tv_over_time_detail_end_time)
        TextView tvEndTime;
