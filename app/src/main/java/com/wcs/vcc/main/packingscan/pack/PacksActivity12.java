...
public class PacksActivity12 extends RingScanActivity implements BluetoothCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new PackAdapter(new RecyclerViewItemListener<Pack>() {
            ...
            public void onClick(Pack item, int position) {
                Intent intent = new Intent(PacksActivity12.this, PackDetailsActivity.class);
...
//                    "^FO175,15" + "\r\n" + "^A0,N,40,40" + "\r\n" + "^FD$%.2f^FS" + "\r\n" +
            ...
            long labelLength = 1000;

//            Date date = new Date();
//            SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
            String dateString =date+"-"+ packList.get(0).RouteCode;



            String header = String.format(tmpHeader, labelLength, storeNumber, Utilities.addChar(String.valueOf(cartonId)) + cartonId, dateString);
