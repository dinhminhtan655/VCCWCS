...
import com.wcs.wcs.R;import com.wcs.vcc.main.phieuhomnay.giaoviec.EmployeeInfo;
...
public class InviteUserAdapter extends ArrayAdapter<EmployeeInfo> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.name.setText(String.format(Locale.getDefault(), "%d %s", item.EmployeeCode, item.getEmployeeName()));
        return convertView;
    }
