...
import com.wcs.vcc.api.HouseKeepingCheckInsertParameter;
        ...
        MyRetrofit.initRequest(this).insertHouseKeepingCheck(new HouseKeepingCheckInsertParameter(LoginPref.getUsername(this), barcode, result, sNote)).enqueue(new Callback<String>() {
            ...
            public void onResponse(Response<String> response, Retrofit retrofit) {
                if (response.isSuccess() && response.body() != null) {
                    PostImage postImage = new PostImage(InsertKVSActivity.this, dialog, snackBarView, sNote, response.body(), new UploadImageCallback() {
                        @Override
