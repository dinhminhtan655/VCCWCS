package com.wcs.vcc.main.giaonhanhoso.cartonreturn;
...
import com.wcs.vcc.api.DSROCartonReturnAddNewParameter;
...
public class DispatchingOrderReturnedActivity extends BaseActivity implements ReceivingCartonReturnAdapter.ChoiceListener {
    private final String TAG = DispatchingOrderReturnedActivity.class.getSimpleName();
    @BindView(R.id.lvOrderDetail)
    ListView listView;
    @BindView(R.id.tv_carton_return_total)
    TextView tvTotal;
    @BindView(R.id.tv_carton_return_selected)
    TextView tvSelected;
    @BindView(R.id.fab)
