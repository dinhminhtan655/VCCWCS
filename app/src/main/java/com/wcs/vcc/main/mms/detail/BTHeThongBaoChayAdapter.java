 ...
 */
public class BTHeThongBaoChayAdapter extends RecyclerView.Adapter<BTHeThongBaoChayAdapter.VH> implements MJDetailAdapter {
    private static final String TAG = BTHeThongBaoChayAdapter.class.getSimpleName();
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == 0) {
            ...
            View view = inflater.inflate(R.layout.item_mj_detail_bt_ht_bao_chay, parent, false);
