...
public class ABAOutboundVinmartActivity extends RingScanActivity implements ABAListItemFragment.ABAOnInputListener {

    private static final String TAG = "ABAOutboundVinmartActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a_b_a_outbound_vinmart);
        ...
        Log.e("name", LoginPref.getRealName(ABAOutboundVinmartActivity.this));
        ...
        mediaPlayer = MediaPlayer.create(ABAOutboundVinmartActivity.this, R.raw.sairoi2);
        mediaPlayer2 = MediaPlayer.create(ABAOutboundVinmartActivity.this, R.raw.nhammaroi);
        list = new ArrayList<XDockVinOutboundPackingViewABA>();

        userName = LoginPref.getUsername(ABAOutboundVinmartActivity.this);
        strDevice = Utilities.getAndroidID(ABAOutboundVinmartActivity.this);
...
//        btChooseDate.setText(Utilities.formatDate_ddMMyyyy(reportDate));
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                switch (compoundButton.getId()) {
                    case R.id.toggleToiLui:
                        if (b) {
                            iToggle = 1;
                            Toast.makeText(ABAOutboundVinmartActivity.this, "" + iToggle, Toast.LENGTH_SHORT).show();
        ...
        imgList.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ABAListItemFragment listItemFragment = ABAListItemFragment.ABAnewInstance(reportDate2, nhom);
        ...
        btnXong.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(ABAOutboundVinmartActivity.this);
...
//            jsonObject.addProperty("Barcode", tv_prev_barcode.getText().toString());
        ...
        jsonObject.addProperty("CustomerID", "VCMFRESH");
...
//        }
        ...
        MyRetrofit.initRequest(ABAOutboundVinmartActivity.this).loadXDockVinOutboundPackingView_ABA(jsonObject).enqueue(new Callback<List<XDockVinOutboundPackingViewABA>>() {
            @Override
...
//                        SettingPref.setCodeItem(OutboundVinmartActivity.this, tv_prev_barcode.getText().toString());
                                    ...
                                    builder.setNegativeButton("Hủy", new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialogInterface, int i) {
                                            ...
                                            if (sLMove2 + Integer.parseInt(item.SLScan) > item.SoBich) {
                                                Toast.makeText(ABAOutboundVinmartActivity.this, "Số move không được lớn hơn SL Chia", Toast.LENGTH_SHORT).show();
                                            } else {
                                                ...
                                                MyRetrofit.initRequest(ABAOutboundVinmartActivity.this).updateXDockVinOutboundPackingDetailMove_ABA(jsonObject2).enqueue(new Callback<String>() {
                                                    @Override
                                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                                        if (response.isSuccess() && response.body() != null) {
                                                            if (response.body().equals("OK")) {
                                                                Toast.makeText(ABAOutboundVinmartActivity.this, "Thành công", Toast.LENGTH_SHORT).show();
                                                    ...
                                                    public void onFailure(Throwable t) {
                                                        Toast.makeText(ABAOutboundVinmartActivity.this, "Kiểm tra kết nối mạng", Toast.LENGTH_SHORT).show();
                                                    }
                                                });
                                            }
                                        }
            ...
            @Override
            public void onFailure(Throwable t) {
                Toast.makeText(ABAOutboundVinmartActivity.this, "Vui lòng kiểm tra kết nối mạng!", Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                            adapter.filter(strP[1]);
                    ...
                    try {
                        if (Integer.parseInt(strP[1]) != Integer.parseInt(tvPalletCurrent.getText().toString())) {
                            ...
                            if (list.get(pos).XacNhan.equals("0")) {
                                ...
                                MyRetrofit.initRequest(ABAOutboundVinmartActivity.this).updateXDockVinOutboundPackingDetailMove_ABA(jsonObject1).enqueue(new Callback<String>() {
                                    @Override
                                    public void onResponse(Response<String> response, Retrofit retrofit) {
                                        if (response.isSuccess() && response.body() != null) {
                                            if (response.body().equals("OK")) {
                                                ...
                                                Toast.makeText(ABAOutboundVinmartActivity.this, "Thất bại", Toast.LENGTH_SHORT).show();
                                            }
                ...
                if (list.size() == 0) {
                    Utilities.speakingSomeThingslow(itemName, ABAOutboundVinmartActivity.this);
                    loadPackingView(tv_prev_barcode.getText().toString());
                } else if (list.size() > 0) {
