...
import com.wcs.vcc.main.kiemcontainer.detail.DetailContainerActivity;
import com.wcs.vcc.preferences.LoginPref;
import com.wcs.vcc.api.ContainerCheckingParameter;
...
public class KiemContainerActivity extends BaseActivity implements AdapterView.OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initialUI();
        gate = LoginPref.getWarehouseID(this);
    ...
    public void getListContainer(final View view) {
        ...
        MyRetrofit.initRequest(this).getContainerChecking(new ContainerCheckingParameter(gate, storeId)).enqueue(new Callback<List<ContainerInfo>>() {
            @Override
    ...
    public void getHistoryChecking(final View view, UUID ContID, final String customerName) {
        final ProgressDialog dialog = Utilities.getProgressDialog(this, getString(R.string.loading_data));
        dialog.show();
        if (!WifiHelper.isConnected(this)) {
            dismissDialog(dialog);
    ...
    public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
        ContainerInfo item = adapter.getItem(position);
        UUID contInOutID = item.getContInOutID();
    ...
    private void startIntentToDetailContainer(ContainerInfo item) {
        ...
        intent.putExtra("CONTAINER_IN_OUT_ID", item.getContInOutID().toString());
